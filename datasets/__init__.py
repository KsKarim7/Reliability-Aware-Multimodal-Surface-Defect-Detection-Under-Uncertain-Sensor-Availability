...
from .eyescandies import load_eyescandies, eyescandies_classes, EyecandiesDataset
...
load_function_dict = {
    ...
    'eyescandies': load_eyescandies,
}

dataset_classes = {
    'mvtec3d': mvtec3d_classes,
    'eyescandies': eyescandies_classes,
}
...
def get_dataloader_from_args(phase, **kwargs):
    if kwargs['dataset'] == 'eyescandies':
        dataset_inst = EyecandiesDataset(
